  ...
  return (
    <Wrapper>
      <div className='ready-container'>
        ...
        <h2>시작하기를 눌러볼까요!</h2>
        <p>
          <img className='key-icon' src={process.env.PUBLIC_URL + '/assets/key-f11.png'} alt="" />
          전체화면으로 더 재밌게 동화를 즐길 수 있어요.</p>

        <p>
          <img className='key-icon' src={process.env.PUBLIC_URL + '/assets/key-left.png'} alt="" />
          <img className='key-icon' src={process.env.PUBLIC_URL + '/assets/key-right.png'} alt="" />
          좌우 방향키로 페이지 이동이 가능하답니다.</p>
        <p>
          <img className='key-icon' src={process.env.PUBLIC_URL + '/assets/key-esc.png'} alt="" />
          동화를 중단하고 책장으로 이동할 수 있어요.</p>
