    ...
    <div>
      ...
      <Wrapper>
        <div className="grid box">
          ...
          <InputGroup size="lg">
            <Form.Control name='newPwCheck' value={form.newPwCheck} onChange={onChangeNewPwCheck} size="lg" className="my-2 form-control" type={showPassword.newPwCheck ? "text" : "password"} placeholder="새로운 비밀번호 확인" style={{ height: '45px', borderRadius: '5px', fontSize: '1rem' }} />
            <InputGroup.Text id="inputGroup-sizing-lg" onClick={() => togglePasswordVisibility('newPwCheck')}>
              <i className={showPassword.newPwCheck ? "fa-solid fa-eye" : "fa-solid fa-eye-slash"}></i>
            </InputGroup.Text>
          </InputGroup>
        ...
        <div className="grid">
          <div className="box">
            ...
            <h5 className="mt-3" style={{fontSize: '20px'}}>기기 연결이 안되어 있어요.</h5>
            <h5><a href="/connect" style={{fontSize: '20px', color: 'black'}}>기기 연결하기 💁‍♀️</a></h5>
          </div>
