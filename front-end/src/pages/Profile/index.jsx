...
function Profile() {
  ...
  const onChangeNewPw = (e) => {
    ...
    const newPwRegExp = /^[a-zA-z0-9]{8,20}$/;
      ...
      <div className="grid box">
        ...
        <Form>
          <Form.Group className="mt-5">
            <Form.Control name='pw' value={form.pw} onChange={onChangePw} size="lg" className="my-3" type="text" placeholder="기존 비밀번호" />
            <Form.Control name='newPw' value={form.newPw} onChange={onChangeNewPw} size="lg" className="my-2" type="text" placeholder="새로운 비밀번호" />
            <span className='message'>{form.newPwMessage}</span>
            <Form.Control name='newPwCheck' value={form.newPwCheck} onChange={onChangeNewPwCheck} size="lg" className="my-3" type="text" placeholder="새로운 비밀번호 확인" />
