                ...
                <div className="container">
                  <div className="message-container">
                    <div className="message-box2">
                      <p>
                        16:00 ~ 19:30 까지 돌봄 공백 영유아를 대상으로
                        어린이집에서는 연장보육제도를 운영해요. <br></br> 주로
                        맞벌이 부모님을 둔 자녀들이 이용하죠.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="container">
                  <div className="message-container">
                    <div className="message-box2">
                      <p>
                        {" "}
                        부모님들은 연장보육시간 동안의 아이 교육적 활동 부족을
                        늘 안타까워해요.😢 <br></br> 그래서 우리는 연장보육반
