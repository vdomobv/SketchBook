const bookData = [
  ...
  {
    id: 14,
    bookcover: 'https://contents.kyobobook.co.kr/sih/fit-in/458x0/pdt/9791158361518.jpg',
    title: '쓰레기통 요정',
    writer: '안녕달',
    summary: `온 동네 쓰레기가 모이는 뒷골목 쓰레기통에서 어느 날 쓰레기통 요정이 태어납니다. 쓰레기통 요정은 파리가 윙윙 날아다니는 잡동사니 틈에서 명랑하게 외칩니다. “소원을 들어 드려요!”

    하지만 사람들은 쓰레기통 요정을 보곤 깜짝 놀라 소리치거나, 무심히 가버립니다. 쓰레기통 요정은 속상한 마음에 엉엉 울다 누군가 지나가는 소리가 들리자 다시 큰 소리로 외칩니다. “소원을 들어 드려요!” 
    
    잔뜩 풀이 죽은 요정은 바람대로 누군가의 소원을 이뤄 줄 수 있을까요? `,
  },
    ];
