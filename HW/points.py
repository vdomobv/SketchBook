...
while cap.isOpened():
    ...
    if(keypoints_with_scores[0][0][1][2] > 0.25 and keypoints_with_scores[0][0][2][2] > 0.25 and keypoints_with_scores[0][0][5][2] > 0.25 and keypoints_with_scores[0][0][6][2] > 0.25 and keypoints_with_scores[0][0][7][2] > 0.25 and keypoints_with_scores[0][0][8][2] > 0.25 and keypoints_with_scores[0][0][9][2] > 0.25 and keypoints_with_scores[0][0][10][2] > 0.25 and keypoints_with_scores[0][0][11][2] > 0.25 and keypoints_with_scores[0][0][12][2] > 0.25 and keypoints_with_scores[0][0][13][2] > 0.25 and keypoints_with_scores[0][0][14][2] > 0.25 and keypoints_with_scores[0][0][15][2] > 0.25 and keypoints_with_scores[0][0][16][2] > 0.25):
